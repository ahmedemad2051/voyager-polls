...
@section('content')
    ...
    <div class="padding-top">
        ...
        <div id="app">
            ...
            <h1 class="page-title">
                <i class="voyager-bar-chart"></i> {{ __('voyager.Polls') }}
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{ __('voyager.Polls') }}</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <table id="dataTable" class="table table-hover dataTable no-footer" role="grid"
                                ...
                                <thead>
                                <tr role="row">
                                    <th class="sorting">{{ __('voyager.Name') }}</th>
                                    <th class="sorting">{{ __('voyager.slug') }}</th>
                                    <th class="sorting">{{ __('voyager.created_at') }}</th>
                                    <th class="sorting">{{ __('voyager.updated_at') }}</th>
                                    <th class="actions sorting">{{ __('voyager.generic_actions') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @foreach($polls as $poll)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="btn-sm btn-danger pull-right delete" data-id="{{ $poll->id }}"
                                                 id="delete-1">
                                                <i class="voyager-trash"></i> {{ __('voyager.generic.delete') }}
                                            </div>
                                            <a href="{{ url(env('ROUTE_PREFIX') . '/admin/polls') . '/' . $poll->id . '/edit' }}"
                                               class="btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> {{ __('voyager.generic.edit') }}
                                            </a>
                                            <a href="{{ url(env('ROUTE_PREFIX') . '/admin/polls') . '/' . $poll->id }}"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Cancel
                            </button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
